    ...
    <div>
        <div class="partL730">
            <div class="boxHui" id="caicy_1">
                <p align="center"><img :src="cybox.picture|handle" alt="看图猜成语游戏在线玩:锦上添花" width="362" height="365"></p>
                <div class="caicy_div">
                    <div style="position:relative;min-height:310px;">
                        ...
                        <div class="caicy_right_div" id="caicy_right_div" v-show='answer'>
                            <h2>{{cybox.title}}的谜底:{{cybox.title}}</h2>
                            ...
                            <div class="caicy_right_item clearfix">
                                ...
                                <div class="caicy_right_item_value">
                                    <a @click="open('/idiom_whole/idiomcontent')" style="cursor:pointer">{{cybox.title}}的意思</a>、
                                    <a @click="open('/idiom_dragon/havedragon')" style="cursor:pointer">{{cybox.title}}成语接龙</a></div>
                            </div>                        
    ...
    export default {
        ...
        methods:{
            getcai(){
                ...
                url+="/cai?limit=1&page="+this.curindex;
                let that=this                           
                    $.ajax({
                        url,
                        type:'get',
                        ...
                        success:function(res){ 
                            ...
                            that.getanswer=that.cybox.title;
                            that.getdetail();
                            that.cutword();
                            that.getdetail();
                        }
